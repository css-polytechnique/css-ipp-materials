...
<br/>
These scores were often used to optimise the number of topics for LDA techniques but not to compare two topic models. Also, these metrics do not correlate well with experts' opinions as explained in the [section 5.2](./bertopic-tutorial.qmd#quantitative-evaluation).
